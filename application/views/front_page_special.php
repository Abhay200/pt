...
<center><img src="<?php echo base_url(); ?>images/car.png" class="img-responsive"></center>
     </td>
   ...
   <!#FFF>
	...
	<div class="form-group">
		<label for="username">EMAIL </label>
		 <input  style="pading-left=30px;" type="text" name="username" required style="text-transform:uppercase" class="form-control">
		</div>
	<div class="form-group">
		<label for="password">Password</label>
		<input type="password" name="password" required class="form-control">
	</div>
	<input style="width:49%;" type="submit" name="submit" value="Passenger Login" class="btn btn-primary">
	<input style="width:49%;" type="submit" name="submit" value="Driver Login" class="btn btn-primary">
	</form>	
	<hr>
